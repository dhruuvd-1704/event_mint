...
const NFTItem = ({ imageSrc, title, price }) => {
  return (
    <div className="size-fit">
      <div className="rounded-lg bg-black bg-opacity-15 space-y-2 shadow-sm shadow-black bg-opacity-25 mb-8">
        ...
        <div>
          ...
          <div className="pb-3 mt-2 flex space-x-3 place-items-center">
            ...
            <button className="font-semibold bg-gradient-to-r from-cyan-500 to-blue-500 text-white p-3 rounded-full hover:p-4 transition-all">
              Buy NFT
            </button>
          </div>
        </div>
